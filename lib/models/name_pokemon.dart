...
NamePokemon namePokemonFromJson(String str) =>
    NamePokemon.fromJson(json.decode(str));

String namePokemonToJson(NamePokemon data) => json.encode(data.toJson());
...
class NamePokemon {
  ...
  factory NamePokemon.fromJson(Map<String, dynamic> json) => NamePokemon(
